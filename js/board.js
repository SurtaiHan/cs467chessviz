...
var pieces = {
    NONE :          {name: "None",          code: " "},
    WHITE_KING :    {name: "White King",    code: "\u265A"},// code: "\u2654"},
    WHITE_QUEEN :   {name: "White Queen",   code: "\u265B"},// code: "\u2655"},
    WHITE_ROOK :    {name: "White Rook",    code: "\u265C"},// code: "\u2656"},
    WHITE_BISHOP :  {name: "White Bishop",  code: "\u265D"},// code: "\u2657"},
    WHITE_KNIGHT :  {name: "White Knight",  code: "\u265E"},// code: "\u2658"},
    WHITE_PAWN :    {name: "White Pawn",    code: "\u265F"},// code: "\u2659"},
